    ...
    return (
        <div>
            <div className="oficial">
               <img src={restaurante} alt="restaurant" className="mx-auto d-block" />
               <a href="https://lenosycarbon.com.co/">PAGIANA OFICIAL</a> 
            </div>
            <div className="historia"> 
                <h1 className="text-center">NUESTRA HISTORIA</h1>
                <p className="text-center m-5">En Leños & Carbón, junto a las Fundaciones Best Buddies y RECA, brindamos
